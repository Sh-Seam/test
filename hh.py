...
def intpu():
    os.system("clear")
    print("\u001b[32;1mEnter 1. => For Sms Bombing.")
    print("\u001b[32;1mEnter 2. => To know your history.")
    print("\u001b[32;1mEnter 3. => To know your IP information.")
    print("\u001b[32;1mNote : To stop this tool Enter ctrl+Z\u001b[0m\n\n")
    

    inpu = int(input("\u001b[32;1m Enter Number =>   \u001b[0m"))
